python train.py --id st --caption_model show_attend_tell --input_json data/cocotalk.json \
...
--learning_rate_decay_start 0 --scheduled_sampling_start 0 --checkpoint_path log_st \
